...
#the associations defined on the model as a shortcut for specifying JOIN clauses for those assoc# incrementally modify your database, and then regenerate this schema definition.
#
